const CARDS = [
    ...
    {type: "PERSON", subType: "INMATE", rarity: "COMMON", faction: "UNALIGNED", name: "Easy target", rank: 1, beat: 3, buy: 2, loot:"1 contraband"},
    {type: "PERSON", subType: "INMATE", rarity: "COMMON", faction: "UNALIGNED", name: "Hoarder", rank: 1, beat: 5, buy: 5, loot:"1 contraband, draw 1 card"},
    {type: "PERSON", subType: "INMATE", rarity: "COMMON", faction: "UNALIGNED", name: "Weasel", rank: 1, beat: 5, buy: 6, loot:"1 favour"},
    {type: "PERSON", subType: "INMATE", rarity: "COMMON", faction: "UNALIGNED", name: "Snitch", rank: 2, beat: 5, buy: 5, loot:"2 contraband",
    ...
    {type: "PERSON", subType: "INMATE", rarity: "COMMON", name: "Boot boy", faction: "WHITE", rank: 5, buy: 10, beat: 12, loot:"3 contraband, 1 favour"},
    ...
    {type: "PERSON", subType: "INMATE", rarity: "COMMON", name: "Black 3", faction: "BLACK", rank: 5, buy: 10, beat: 12, loot:"3 contraband, 1 favour"},
    ...
    {type: "PERSON", subType: "INMATE", rarity: "COMMON", name: "Asian 3", faction: "ASIAN", rank: 5, buy: 10, beat: 12, loot:"3 contraband, 1 favour"},
    ...
    {type: "PERSON", subType: "INMATE", rarity: "COMMON", name: "Latino 3", faction: "LATINO", rank: 5, buy: 10, beat: 12, loot:"3 contraband, 1 favour"},
    ...
    { type: "PERSON", subType: "GUARD", rarity: "UNCOMMON", name: "Guard 2", buy: 15,
        additionalCost: "Frame 2 inmates", ability: "Take 2 contraband. Draw 1 card."
    },
    {type: "PERSON", subType: "GUARD", rarity: "UNCOMMON", name: "Guard 1", buy: 5,
        additionalCost: "Frame 1 inmate", ability: "The effect of all items are removed from the current fight."
    },
    {type: "PERSON", subType: "GUARD", rarity: "UNCOMMON", name: "Ku Klux Guard", buy: 10,
        additionalCost: "Frame 1 non-white inmate", ability: "Draw a favour. Gain 1 White popularity."
    },
    {type: "PERSON", subType: "GUARD", rarity: "UNCOMMON", name: "Malcom Guard", buy: 10,
